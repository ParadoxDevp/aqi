...
AQI is a numerical scale used to communicate how polluted the air is and the potential health effects associated with it.
...
### 1. Calculate Sub-Index for Each Pollutant
...
### 2. Determine Final AQI

After calculating the sub-index for each pollutant:
...
3. Calculate sub-index using the interpolation formula.
...
This project demonstrates how environmental monitoring systems convert **raw sensor readings** into a **standardized air quality index** that can be easily interpreted by users and decision-making systems.
